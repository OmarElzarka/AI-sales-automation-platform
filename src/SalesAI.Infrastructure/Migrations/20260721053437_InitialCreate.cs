        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScoreCategory = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ScoreNumeric = table.Column<int>(type: "int", nullable: true),
                    ScoreReasoning = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumericScore = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeadScoreHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LeadScoreHistory_Leads_LeadId",
                        column: x => x.LeadId,
                        principalTable: "Leads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeadTags", x => new { x.LeadsId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_LeadTags_Leads_LeadsId",
                        column: x => x.LeadsId,
                        principalTable: "Leads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LeadTags_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AIGeneratedContent_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AIGeneratedContent_Deals_DealId",
                        column: x => x.DealId,
                        principalTable: "Deals",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AIGeneratedContent_Leads_LeadId",
                        column: x => x.LeadId,
                        principalTable: "Leads",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AIGeneratedContent_Users_RequestedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesTasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SalesTasks_Contacts_ContactId",
                        column: x => x.ContactId,
                        principalTable: "Contacts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SalesTasks_Deals_DealId",
                        column: x => x.DealId,
                        principalTable: "Deals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_SalesTasks_Leads_LeadId",
                        column: x => x.LeadId,
                        principalTable: "Leads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_SalesTasks_Users_AssignedToId",
                        column: x => x.AssignedToId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIGeneratedContent_CompanyId",
                table: "AIGeneratedContent",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_AIGeneratedContent_DealId",
                table: "AIGeneratedContent",
                column: "DealId");

            migrationBuilder.CreateIndex(
                name: "IX_AIGeneratedContent_LeadId",
                table: "AIGeneratedContent",
                column: "LeadId");

            migrationBuilder.CreateIndex(
                name: "IX_AIGeneratedContent_RequestedById",
                table: "AIGeneratedContent",
                column: "RequestedById");

            migrationBuilder.CreateIndex(
                name: "IX_AIGeneratedContent_Type",
                table: "AIGeneratedContent",
                column: "Type");

            migrationBuilder.CreateIndex(
                name: "IX_AutomationLogs_Status",
                table: "AutomationLogs",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_AutomationLogs_WorkflowName",
                table: "AutomationLogs",
                column: "WorkflowName");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Leads_ScoreCategory",
                table: "Leads",
                column: "ScoreCategory");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeadScoreHistory_LeadId",
                table: "LeadScoreHistory",
                column: "LeadId");

            migrationBuilder.CreateIndex(
                name: "IX_LeadTags_TagsId",
                table: "LeadTags",
                column: "TagsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesTasks_AssignedToId",
                table: "SalesTasks",
                column: "AssignedToId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesTasks_ContactId",
                table: "SalesTasks",
                column: "ContactId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesTasks_DealId",
                table: "SalesTasks",
                column: "DealId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesTasks_DueDate",
                table: "SalesTasks",
                column: "DueDate");

            migrationBuilder.CreateIndex(
                name: "IX_SalesTasks_LeadId",
                table: "SalesTasks",
                column: "LeadId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesTasks_Status",
                table: "SalesTasks",
                column: "Status");
